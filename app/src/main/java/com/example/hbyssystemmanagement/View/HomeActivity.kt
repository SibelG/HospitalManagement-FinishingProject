...
class HomeActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomView.setOnNavigationItemReselectedListener {BottomNavigationView.OnNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.sections -> {
                    startActivity(Intent(applicationContext,SectionList::class.java))
                    return@OnNavigationItemSelectedListener true
                }
                ...
                R.id.nav_Appointment->{
                    startActivity(Intent(applicationContext,ViewAppointmentActivity::class.java))
                    return@OnNavigationItemSelectedListener true
                }
                R.id.emergence->{
                startActivity(Intent(applicationContext,SearchNearPlace::class.java))
                return@OnNavigationItemSelectedListener true
                }
                R.id.nav_Visited->{
 ...
 override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.nav_menu) {
            ...
            startActivity(intent)
        }else if (id == R.id.nav_e_Pulse) {
            val intent = Intent(this@HomeActivity, ePulseActivity::class.java)
            startActivity(intent)
